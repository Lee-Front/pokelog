...
const DEFAULT_EVOLUTION_SHOP_ITEMS = {
  ...
  "leaders-crest": { name: "Leader's Crest", price: 3000, category: "special" },
  "leaf-stone": { name: "Leaf Stone", price: 3000, category: "special" },
  "metal-alloy": { name: "Metal Alloy", price: 3000, category: "special" },
  ...
  "syrupy-apple": { name: "Syrupy Apple", price: 2200, category: "special" },
...
export const DEFAULT_CONFIG: ServerConfig = {
  ...
  moveChangeCost: 500,
  // 개체값(IV)/성격/특성 자유 변경 비용(게임머니). 아이템 없이 게임머니로만 조정하는 챔피언스식 튜닝.
  // IV는 정액이 아니라 **올린 개체값 1포인트당** ivPointCost(6스탯 증가분 합 × 100; 내리는 건 무료) —
  // 전 스탯 31 만들기가 자연히 비싸진다. 성격/특성은 바꿀 때 각각 정액. 운영자가 /admin에서 튜닝.
  tuning: { ivPointCost: 100, natureCost: 1000, abilityCost: 1500 },
