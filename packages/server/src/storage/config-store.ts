...
const DEFAULT_MEGA_SHOP_ITEMS = {
  "abomasnowite": { name: "Abomasnowite", price: 1500 },
  "absolite": { name: "Absolite", price: 1500 },
  "aerodactylite": { name: "Aerodactylite", price: 1500 },
  "aggronite": { name: "Aggronite", price: 1500 },
  "alakazamite": { name: "Alakazamite", price: 1500 },
  "altarianite": { name: "Altarianite", price: 1500 },
  "ampharosite": { name: "Ampharosite", price: 1500 },
  "audinite": { name: "Audinite", price: 1500 },
  "banettite": { name: "Banettite", price: 1500 },
  "beedrillite": { name: "Beedrillite", price: 1500 },
  "blastoisinite": { name: "Blastoisinite", price: 1500 },
  "blazikenite": { name: "Blazikenite", price: 1500 },
  "cameruptite": { name: "Cameruptite", price: 1500 },
  "charizardite-x": { name: "Charizardite X", price: 1500 },
  "charizardite-y": { name: "Charizardite Y", price: 1500 },
  "diancite": { name: "Diancite", price: 1500 },
  "galladite": { name: "Galladite", price: 1500 },
  "garchompite": { name: "Garchompite", price: 1500 },
  "gardevoirite": { name: "Gardevoirite", price: 1500 },
  "gengarite": { name: "Gengarite", price: 1500 },
  "glalite": { name: "Glalite", price: 1500 },
  "gyaradosite": { name: "Gyaradosite", price: 1500 },
  "heracrossite": { name: "Heracrossite", price: 1500 },
  "houndoomite": { name: "Houndoomite", price: 1500 },
  "kangaskhanite": { name: "Kangaskhanite", price: 1500 },
  "latiasite": { name: "Latiasite", price: 1500 },
  "latiosite": { name: "Latiosite", price: 1500 },
  "lopunnite": { name: "Lopunnite", price: 1500 },
  "lucarionite": { name: "Lucarionite", price: 1500 },
  "manectite": { name: "Manectite", price: 1500 },
  "mawilite": { name: "Mawilite", price: 1500 },
  "medichamite": { name: "Medichamite", price: 1500 },
  "metagrossite": { name: "Metagrossite", price: 1500 },
  "mewtwonite-x": { name: "Mewtwonite X", price: 1500 },
  "mewtwonite-y": { name: "Mewtwonite Y", price: 1500 },
  "pidgeotite": { name: "Pidgeotite", price: 1500 },
  "pinsirite": { name: "Pinsirite", price: 1500 },
  "sablenite": { name: "Sablenite", price: 1500 },
  "salamencite": { name: "Salamencite", price: 1500 },
  "sceptilite": { name: "Sceptilite", price: 1500 },
  "scizorite": { name: "Scizorite", price: 1500 },
  "sharpedoite": { name: "Sharpedoite", price: 1500 },
  "slowbronite": { name: "Slowbronite", price: 1500 },
  "steelixite": { name: "Steelixite", price: 1500 },
  "swampertite": { name: "Swampertite", price: 1500 },
  "tyranitarite": { name: "Tyranitarite", price: 1500 },
  "venusaurite": { name: "Venusaurite", price: 1500 },
